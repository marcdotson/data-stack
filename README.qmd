...
Any file or folder that begins with a period is hidden (i.e., you won't see it in your OS file explorer by default, but you will see it in the explorer in Positron). The `.gitignore` file is what controls which files and folders are pushed. Note that the [project template](https://github.com/marcdotson/project-template) also includes instructions for using the project environment and as a link to this training.

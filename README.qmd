...
o	Start the data stack with Positron and its Python bootstrap via uv.
	Consider JupyterHub (or Posit Cloud or codespaces) to start.
	See https://github.com/posit-dev/positron/pull/13895.
o	Reference the upcoming packages pane within Positron?
o	Reference the upcoming Posit Assistant within Positron?
o	Reference the in-line support for Quarto in Positron’s notebook editor.
